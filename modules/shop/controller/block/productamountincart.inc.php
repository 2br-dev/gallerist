...
class ProductAmountInCart extends StandartBlock
{
    ...
    function actionIndex()
    {
        ...
        if ($cart_item) {
            ...
            /** @var Product $product */
            $amount = (isset($products_in_cart[$product['id']])) ? reset($products_in_cart[$product['id']])['amount'] : 0;
        ...
        $is_cart_page = in_array(RouterManager::getCurrentRoute()->getId(), ['shop-front-cartpage', 'shop-front-cartcheckout']);
        $cart_amount_options = [
