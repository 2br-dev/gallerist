...
class OrderShipmentCtrl extends Crud
{
    ...
    function helperIndex()
    {
        ...
        $helper->setTopHelp(t('В данном разделе можно просматривать созданные документы отгрузки заказов. Перейдя к транзакции, можно отправить чек отгрузки в ОФД. ' .
            'Также в настройках модуля можно настроить автоматическую отправку чека при создании документа отгрузки.'));
