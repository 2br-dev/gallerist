...
class CashRegisterApi
{
    ...
    */
     ...
     * @return array
     */
    public static function getStaticPaymentMethods($first = array())
    {
        $result = array(
     ...
     * @return array
     */
    public static function getStaticPaymentSubjects($first = array())
    {
        $result = array(
     ...
     * @return array
     */
    public static function getStaticSnoList($first = array())
    {
        return $first + array(
