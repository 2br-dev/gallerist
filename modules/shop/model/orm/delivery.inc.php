 ...
 * @property integer $min_price Минимальная сумма заказа
 * @property integer $max_price Максимальная сумма заказа
 * @property integer $min_weight Минимальный вес заказа гр.
 * @property integer $max_weight Максимальный вес заказа гр.
...
class Delivery extends OrmObject
{
        ...
        parent::_init()->append(array(
            t('Основные'),
                ...
                'parent_id' => new Type\Integer(array(
                    ...
                    'default' => 0,
                    'allowEmpty' => false,
                    'list' => array(array('\Shop\Model\DeliveryDirApi', 'staticSelectList'), 0, [0 => t('- Без группы -')])
                )),
    ...
    {
        return $this->getTypeObject()->getDeliveryCost($order, $address, $this, $use_currency);
    }
