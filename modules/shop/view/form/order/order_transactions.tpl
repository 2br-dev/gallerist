            ...
            {foreach $transactions as $transaction}
                <div class="order-transactions_item">
                    <div class="order-transactions_item-title">
                        <strong>№ {$transaction['id']} &mdash; {$transaction['reason']} &mdash; {$transaction['__status']->textView()}</strong>
                        <span>
                    ...
                    <div class="order-transactions_item-logs">
                        ...
                        {/foreach}
                        <div>
                            <span>{$transaction.dateof|dateformat: "@date @time"} &mdash; {t}Транзакция создана{/t}</span>
                        </div>
                    </div>
                </div>
            {/foreach}
