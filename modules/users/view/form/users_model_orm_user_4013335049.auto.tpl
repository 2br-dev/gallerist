        ...
        <form method="POST" action="{urlmake}" enctype="multipart/form-data" class="tab-content crud-form">
            <input type="submit" value="" style="display:none"/>
                        <div class="tab-pane active" id="users-user-tab0" role="tabpanel">
                                ...
                                <tr>
                                    <td class="otitle">{$elem.__city->getTitle()}&nbsp;&nbsp;{if $elem.__city->getHint() != ''}<a class="help-icon" data-placement="right" title="{$elem.__city->getHint()|escape}">?</a>{/if}
                                    </td>
                                    <td>{include file=$elem.__city->getRenderTemplate() field=$elem.__city}</td>
                                </tr>
                        ...
                        <div class="tab-pane" id="users-user-tab8" role="tabpanel">
                                ...
                                <tr>
                                    <td class="otitle">{$elem.__is_author->getTitle()}&nbsp;&nbsp;{if $elem.__is_author->getHint() != ''}<a class="help-icon" data-placement="right" title="{$elem.__is_author->getHint()|escape}">?</a>{/if}
                                    </td>
                                    <td>{include file=$elem.__is_author->getRenderTemplate() field=$elem.__is_author}</td>
                                </tr>
