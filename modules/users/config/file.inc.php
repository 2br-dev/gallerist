...
class File extends ConfigObject
{
    ...
    function _init()
    {
        parent::_init()->append(array(
            t('Основные'),
                ...
                'replace_country_phone_code' => new Type\Integer(array(
                ...
                'country_phone_length' => new Type\Integer(array(
                ...
                'default_country_phone_code' => new Type\Integer(array(
    ...
    public static function getDefaultValues()
    {
        return parent::getDefaultValues() + array(
                'tools' => array(
                    array(
                        'url' => RouterManager::obj()->getAdminUrl('ajaxNormalizeUserPhones', array(), 'users-tools'),
    ...
    /**
     * Возвращает правильный url для авторизации
     * @return string
     */
    public function getAuthUrl()
    {
        if ($this->isPhoneAuth()) {
            return Manager::obj()->getUrl('users-front-auth', ['Act'=>'phoneauth']);
        }
        return Manager::obj()->getUrl('users-front-auth');
    }
