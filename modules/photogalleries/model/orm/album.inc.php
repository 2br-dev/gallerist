...
class Album extends \RS\Orm\OrmObject
{
    ...
    {        
        parent::_init()->append(array(
            ...
            'title' => new Type\Varchar(array(
                ...
                'checker' => array('chkEmpty', t('Укажите название альбома')),
                'attr' => array(array(
            ...
            'alias' => new Type\Varchar(array(
                ...
                'checker' => array('chkEmpty', t('Укажите идентификатор альбома')),
                'meVisible' => false
            )),
    ...
    */
    function getUrl()
    {
       return \RS\Router\Manager::obj()->getUrl('photogalleries-front-album',array(
           'id' => $this['alias']
       )); 
    }
