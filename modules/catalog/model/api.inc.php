...
class Api extends EntityList
{
    ...
    */
     ...
     * @throws RSException
     */
    public static function encodeDirFilterParamsToUrl(Dir $category = null, $bfilters = array(), $pf = array(), $query = "", $additional_params = array())
    {
        static
     ...
     * @throws RSException
     */
    public static function getCategoryPaginatorRouteParamsForProductsList(Dir $category, $bfilters = array(), $pf = array(), $query = "", $additional_params = array())
    {
