 ...
 * @property integer $round Округление
...
class Typecost extends OrmObject
{
    ...
    function _init()
    {
        parent::_init()->append(array(
            ...
            'depend' => new Type\Integer(array(
                ...
                'List' => array(array('\Catalog\Model\CostApi', 'getManualCostList')),
                'visible' => false,
            )),
            'round' => new Type\Decimal(array(
    ...
    function delete()
    {
        ...
        $count = OrmRequest::make()->from($this)
            ->where(array('site_id' => $site_id))->count();
