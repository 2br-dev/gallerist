...
class OneClickApi extends EntityList
{
    ...
    private $click_info = array(); //Массив полей для отправки и сохранения
    ...
    function getPreparedProductsFromCart()
    {
        ...
        foreach ($product_items as $item) {
            ...
            $event_result = EventManager::fire('oneclick.addproduct.before', array(
                'product' => $product,
                'cartitem' => $cartitem,
            ));
    ...
    function createOrderFromOneClick(Orm\OneClickItem $oneclick)
    {
        ...
        if (!empty($products)) {
            ...
            foreach ($products as $product_info) {
                ...
                $event_result = EventManager::fire('oneclick.createorder.addproduct.before', array(
