...
*/
class SetOfferStockNum extends \ExternalApi\Model\AbstractMethods\AbstractAuthorizedMethod
{
    ...
    */
    ...
    /**
    * Обновляет указанный остаток на конкретном складе для товара
    * 
    ...
    * @param string $warehouse_id id склада или его название как на сайте. Например: 'Основной склад'
    * @param float $value новое значение остатка. Например 12.00
    * @param array $regfields_arr поля пользователя из настроек модуля пользователь
    *
    * @example POST|GET /api/methods/product.setOfferStockNum?token=b45d2bc3e7149959f3ed7e94c1bc56a2984e6a86&client_id=sadasljcsdacnilsdanhoiuh3214&product_id=1&offer_id=1&warehouse_id=Основной склад&value=100.00
    * 
    * <pre>
    *  {
    *      "response": {
    ...
    */
    protected function process($token, $client_id, $client_secret, $product_id, $offer_id, $warehouse_id, $value)
    {
