...
class PhpVersion extends AbstractSystemTest
{
    ...
    {
        return t('Версия PHP должна быть %version или выше', array('version' => self::NEED_PHP_VERSION));
    }
    ...
    {
        return t('Установите на хостинге версию PHP, не ниже %version', array('version' => self::NEED_PHP_VERSION));
    }
}