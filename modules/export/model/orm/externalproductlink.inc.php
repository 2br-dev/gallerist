...
class ExternalProductLink extends AbstractObject
{
    ...
    function _init()
    {
        ...
        $this->addIndex(array('profile_id', 'product_id', 'offer_id'), self::INDEX_UNIQUE);
    }
    ...
    {
        $this['ext_data_array'] = @json_decode($this['ext_data'], true) ?: array();
    }
