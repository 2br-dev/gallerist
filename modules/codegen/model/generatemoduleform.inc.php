    ...
    function __construct()
    {
        $properties = new \RS\Orm\PropertyIterator(array(
            'name' => new Type\Varchar(array(
                ...
                'checker' => array('chkEmpty', t('Укажите имя дополнения')),
                ' checker' => array('chkPattern', t('Неверные символы в имени дополнения'), '/^[a-z0-9]+$/i'),
                '  checker' => array('chkPattern', t('Не должно начинаться с цифры'), '/^[^0-9]+[a-z0-9]+$/i'),
            ...
            'title' => new Type\Varchar(array(
                ...
                'checker' => array('chkEmpty', t('Поле должно быть заполнено')),
                'attr'=>array(array('placeholder' => t('Мой модуль'))),
            )),
            'description' => new Type\Text(array(
                'description' => t('Краткое описание модуля'),
                'checker' => array('chkEmpty', t('Поле должно быть заполнено')),
                'attr'=>array(array('placeholder' => t('Описание моего модуля'))),
            )),
