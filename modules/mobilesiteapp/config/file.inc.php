        ...
        parent::_init()->append(array(
            t('Основные'),
                ...
                'root_dir' => new Type\Integer(array(
                    ...
                    'tree' => array(array('\Catalog\Model\DirApi','staticTreeList'), 0, array(0 => t('- Корень категория -'))),
                ...
                'top_products_dir' => new Type\Integer(array(
                    ...
                    'tree' => array(array('\Catalog\Model\DirApi','staticSpecTreeList'), 0, array('' => t('- Не выбрана -'))),
                ...
                'article_root_category' => new Type\Integer(array(
                    'description' => t('Корневой элемент новостей'),
                    'hint' => t('С какой категории выводить'),
                    'tree' => array(array('\Article\Model\CatApi', 'staticTreeList'), 0, array(0 => t('- Верхний уровень -'))),
                )),
