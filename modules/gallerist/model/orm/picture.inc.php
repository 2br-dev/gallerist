 ...
 * @property integer $min_order Минимальное количество товара для заказа
 * @property integer $max_order Максимальное количество товара для заказа
    ...
    function _init()
    {
        parent::_init()->append(array(
            t('Основные'),
                ...
                'min_order' => new Type\Decimal(array(
                    'maxLength' => 11,
                    'decimal' => 3,
                    'mevisible' => true,
                ...
                'max_order' => new Type\Decimal(array(
                    'maxLength' => 11,
                    'decimal' => 3,
                    'mevisible' => true,
