...
use Gallerist\Model\Orm\Picture;
 ...
 */
class PictureApi extends EntityList
{
    ...
    /**
     * Возвращает список материалов для добавления картины
     * @param $params
     * @return array
     */
    public static function getMaterialsList($params)
    {
    ...
    /**
     * Возвращает список форм для добавления картины
     * @param $params
     * @return array
     */
    public static function getShapesList($params)
    {
        $config = \RS\Config\Loader::byModule('gallerist');
        $prop = new \Catalog\Model\Orm\Property\Item($config['prop_shape']);
        $values = $prop->getAllowedValues();
        return array_replace($params, $values);
    }

    /**
     * Возвращает список стилей для добавления картины
     * @param $params
     * @return array
     */
    public static function getStylesList($params)
    {
        $config = \RS\Config\Loader::byModule('gallerist');
        $prop = new \Catalog\Model\Orm\Property\Item($config['prop_style']);
        $values = $prop->getAllowedValues();
        return array_replace($params, $values);
    }

    /**
     * Возвращает список основ для добавления картины
     * @param $params
     * @return array
     */
    public static function getBasesList($params)
    {
        $config = \RS\Config\Loader::byModule('gallerist');
        $prop = new \Catalog\Model\Orm\Property\Item($config['prop_base']);
        $values = $prop->getAllowedValues();
        return array_replace($params, $values);
    }

    /**
     * Возвращает список Ориентация для добавления картины
     * @param $params
     * @return array
     */
    public static function getOrientationsList($params)
    {
        $config = \RS\Config\Loader::byModule('gallerist');
        $prop = new \Catalog\Model\Orm\Property\Item($config['prop_orientation']);
        $values = $prop->getAllowedValues();
        return array_replace($params, $values);
    }

    /**
     * Возвращает список тем для добавления картины
     * @param $params
     * @return array
     */
    public static function getThemesList($params)
    {
        $config = \RS\Config\Loader::byModule('gallerist');
        $prop = new \Catalog\Model\Orm\Property\Item($config['prop_theme']);
        $values = $prop->getAllowedValues();
        return array_replace($params, $values);
    }
