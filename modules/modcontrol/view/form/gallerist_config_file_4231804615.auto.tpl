        ...
        <form method="POST" action="{urlmake}" enctype="multipart/form-data" class="tab-content crud-form">
            <input type="submit" value="" style="display:none">
                            ...
                            <div class="tab-pane" id="gallerist-config-file-tab1" role="tabpanel">
                                        ...
                                        <tr>
                                        <td class="otitle">{$elem.__prop_region->getTitle()}&nbsp;&nbsp;{if $elem.__prop_region->getHint() != ''}<a class="help-icon" data-placement="right" title="{$elem.__prop_region->getHint()|escape}">?</a>{/if}
                                        </td>
                                        <td>{include file=$elem.__prop_region->getRenderTemplate() field=$elem.__prop_region}</td>
                                        </tr>
