    ...
    {if $elem._before_form_template}{include file=$elem._before_form_template}{/if}
        ...
        <form method="POST" action="{urlmake}" enctype="multipart/form-data" class="crud-form">
            ...
            <div class="notabs">
                                    ...
                                    <tr>
                                    <td class="otitle">{$elem.__allow_remote_install->getTitle()}&nbsp;&nbsp;{if $elem.__allow_remote_install->getHint() != ''}<a class="help-icon" title="{$elem.__allow_remote_install->getHint()|escape}">?</a>{/if}
                                    </td>
                                    <td>{include file=$elem.__allow_remote_install->getRenderTemplate() field=$elem.__allow_remote_install}</td>
                                    </tr>
