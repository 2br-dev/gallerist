...
class PresetApi extends BaseModel
{
    ...
    {
        $response = self::makeApiRequest(self::API_GET_PRESET, self::METHOD_GET, array(
            'id' => $id
        ));
     ...
     * @return array
     */
    public static function getCategoryStaticList($first = array())
    {
     ...
     * @return array
     */
    public static function getPresetsStaticList($first = array())
    {
     ...
     * @return array
     */
    public static function makeApiRequest($method, $type = 'GET', $data = array())
    {
        $params = array();
