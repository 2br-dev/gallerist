...
/**
 * Class FlexAlignItems - класс для свойства горизонтального позиционирования CSS через Flex
 */
class FlexAlignItems extends AlignItems {
     ...
     */
    function __construct($property, $title, $value = null, $data = array())
    {
