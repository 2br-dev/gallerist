...
/**
 * Class Size - класс для свойства CSS задающего цвет для отображения
 */
class Color extends AbstractCssProperty {
     ...
     */
    function __construct($property = "color", $title = "Цвет", $value = '', $data = array())
    {
