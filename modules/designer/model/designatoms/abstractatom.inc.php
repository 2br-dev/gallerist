...
abstract class AbstractAtom{
    ...
    protected $attrs = array(); //Аттрибуты компонента для редактирования
    protected $attr_groups = array(); //Группы аттрибутов
    /**
     * @var CSSPresets\AbstractCssPreset[] $css_presets
     */
    protected $css_presets = array(); //Массив пресетов с группированными CSS свойств
    /**
     * @var CSSProperty\AbstractCssProperty[] $css
     */
    protected $css = array(); //CSS cвойства компонента для редактирования
