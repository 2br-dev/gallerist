                    ...
                    <table class="cartTable">
                        <tbody>
                            ...
                            <tr data-id="{$index}" data-product-id="{$cartitem.entity_id}" class="cartitem{if $item@first} first{/if}">
                                ...
                                <td class="price">
                                    <div class="amount">
                                        <input type="hidden" min="{$product->getAmountStep()}" step="{$product->getAmountStep()}" class="fieldAmount" value="{$cartitem.amount}" name="products[{$index}][amount]" {if $shop_config.allow_buy_all_stock_ignoring_amount_step}data-break-point="{$product->getNum()}"{/if}>
                                ...
                                <td class="remove">
                                    {if !$cartitem->getForbidRemove()}
                                        <a href="{$router->getUrl('shop-front-cartpage', ["Act" => "removeItem", "id" => $index, "floatCart" => $floatCart])}" title="{t}Удалить товар из корзины{/t}" class="iconX"></a>
                                    {/if}
                                </td>
                            </tr>
