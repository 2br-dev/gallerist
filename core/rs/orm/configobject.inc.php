...
abstract class ConfigObject extends AbstractObject implements ConfigInterface
{
    ...
    function _init()
    {
        $properties = $this->getPropertyIterator()->append(array(
            t('Основные'),
                ...
                'deactivated' => new Type\Integer(array(
    ...
    public static function getDefaultValues()
    {
        ...
        if (!$result = ModuleItem::parseModuleXml($filename)) {
            throw new ModuleException(t('Не удается найти или распарсить XML файл конфигурации модуля %module - %file', array('module' => $this_module, 'file' => $filename)));
        }
