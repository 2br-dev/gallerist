...
class Auth
{
    ...
    */
    ...
    {
        if ($remember) {
            \RS\Application\Application::getInstance()->headers->addCookie(self::COOKIE_AUTH_TICKET, self::getAuthTicket($user), time()+self::COOKIE_AUTH_TICKET_LIFETIME, '/', \Setup::$COOKIE_AUTH_DOMAIN);
        } else {
