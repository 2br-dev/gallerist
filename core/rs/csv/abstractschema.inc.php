...
abstract class AbstractSchema extends BaseModel
{
    ...
    public function __construct($base_preset, array $other_presets = array(), $options = array())
    {
    ...
    public function import($file, $check_timeout = false, $start_pos = 0, $site_id = null)
    {
        ...
        while ($fp
            ...
            $event_result = EventManager::fire('csv.beforelineimport.' . $class_short_name, array(
                'schema' => $this
            ));
