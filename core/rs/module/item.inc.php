...
class Item
{
    ...
    */
    ...
    function uninstall()
    {
        ...
        if ($config->isLicenseUpdateExpired()) {
            return array(t('Невозможно удалить модуль с истёкшим периодом обновлений'));
        }
    ...
    */
    public function getTools()
    {
        ...
        $tools['resetSettings'] = array(
                'url' => $router->getAdminUrl('AjaxResetSettings', array('module' => $this->mod_name), 'modcontrol-control'),
